...
describe "student_lists/new" do
  ...
  it "renders new student_list form" do
    ...
    assert_select "form[action=?][method=?]", student_lists_path, "post" do
      ...
      assert_select "select#student_list_classification[name=?]", "student_list[classification]"
      ...
      assert_select "select#student_list_longterm[name=?]", "student_list[longterm]"
